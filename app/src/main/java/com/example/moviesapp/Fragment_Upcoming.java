...
public class Fragment_Upcoming extends Fragment {
    ...
    public static String Json_url = "https://api.themoviedb.org/3/movie/upcoming?api_key=f95436d72b182429105097fb8b1ecfb1";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Retrofit retrofit=new Retrofit.Builder()
                ...
                .build();
        api_call_upcoming api_call=retrofit.create(api_call_upcoming.class);
