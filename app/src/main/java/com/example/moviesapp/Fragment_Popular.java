...
public class Fragment_Popular extends Fragment {
    ...
    public static String Json_url = "https://api.themoviedb.org/3/movie/popular?api_key=f95436d72b182429105097fb8b1ecfb1";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        api_call_popular api_call=retrofit.create(api_call_popular.class);
